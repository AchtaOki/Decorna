  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item">
          <a class="nav-link " style="color:white" href="admin.php?action=add_product">Ajouter un produit</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " style="color:white" href="admin.php?action=modif_suppr">Admin</a>
        </li>
      </ul>
